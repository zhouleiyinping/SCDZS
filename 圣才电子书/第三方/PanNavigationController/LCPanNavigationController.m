...
- (void)pushViewController:(UIViewController *)viewController animated:(BOOL)animated
{
    ...
    if (previousViewController) {
        ...
        dispatch_after(popTime, dispatch_get_main_queue(), ^(void){
            ...
            [shotInfo setObject:contentImage forKey:contentImageKey];
            [shotInfo setObject:barImage forKey:barImageKey];
            [shotInfo setObject:[NSValue valueWithCGRect:previousViewController.view.frame] forKey:contentFrameKey];
